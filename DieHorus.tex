...
Die Turmuhr der Peterskirche läutete: "`Ich will nicht drängeln, aber wir haben ein grosses Programm. Peter willst uns nicht deine Kirche zeigen?"' mischte sich Thot ein. "`Na, klar! Kommt! Ich habe schon alles vorbereitet!"' Peter stieg die wenigen Stufen zum Eingang hoch und öffnete ihnen die grosse Holztür: "`Seit willkommen in meinem bescheidenen Reich!"'
...
-'Der edle Hapi hat sicher nichts dagegen, wenn wir dich nötigenfalls verbessern.' Hörnchen schaffte es, selbst seinen Gedanken einen arroganten Tonfall zu geben. -'Oder zu ergänzen!' Auch Schlange konnte ausgesprochen nasal denken. -'Was für ein Dunkel, was für ein grausiges Dunkel\dots' bei Tasse schienen ausser der Tasse auf seinem Kopf, einige andere in seinem 'Schrank' zu fehlen, dachte Hapi. Die Gedanken waren wie mehrere Knäule aus bunter Wolle mit der eine siebenköpfige Bande Kätzchen gespielt hatte. -Wenn man genauer hinsieht, dachte Hapi, sind Wolle und Kätzchen das Letzte, was zu dem schwarzen, abgrundtiefen Geflächt an Erinnerungen und Verwirrung passt\dots
...
Nachdem die Lockerungsübungen fertig waren,, rückte er den Stuhl zurecht und liess die letzte Nacht an seinem inneren Auge vorbeiziehen. Wer hätte das gedacht? Er hatte geglaubt so kurz vor seiner Pensionierung, hätte er alles gesehen, was es in seinem Beruf als Streifenpolizist zu sehen gäbte. Aber er musste zugeben: Er hatte sich getäuscht. Er liess die Finger auf die Tasten sinken und begann zu schreiben:

{\tt Protokoll vom 26.12.20XX
 
22:05: Meldung in der Leitstelle: Der Portier des Hotels 'Troi Roi', Herr Hässler, meldet, dass sich zwei auffällige Personen vor dem Restaurant 'Lälle König' aufhalten. Sie seien nackt und würden laut schreien.
...
22:20: Die Polizisten Moser und Meyer fahren von der Marktgasse in die Gerbergasse. Auf der Höhe der Post sehen wir die verdächtigen Personen. Wie von den Zeugen berichtet sind es zwei grosse, nackte Männer. Einer von ihnen trägt eine Art Tier auf dem Rücken. Die Kollegin Meyer ruft die beiden Männer an, sie sollen stehenbleiben. Sie tun so, als ob sie uns nicht sehen würden und gehen weiter die Gerbergasse hoch.

22:25: Die Polizisten Meyer und Moser verlassen den Wagen und folgen den Männern. Sie holen sie auf der Höhe des Gerberbrunnens ein. Dort sind die beiden stehen geblieben. Die beiden scheinen aufgeregt und reden laut. Beide legen sich auf den Boden. Es hat sieht aus, als würden sie am Boden horchen. "`Unheimlich!"' ruft der mit dem Tier auf dem Rücken. Das Tier zappelt. "`Das ist die Mitte vom Ei!"' Sagt der andere. Die beiden Beamten, die bisher beobachtend im Hintergrund geblieben waren, nehmen jeweils einen der Herren in die Zange und bitten sie aufzustehen und ihr Verhalten zu erklären.

22:30: Die beiden Herren denken nicht daran. Da beide sehr gross und kräftig sind, haben sie keine Schwierigkeiten die beiden Beamten Meyer und Moser abzuschütteln. Der, der das Tier auf dem Rücken trägt, nimmt es und reisst daran und plötzlich gibt es ein Durcheinander.}

Der Beamte Moser überlegt. -Durcheinander, weiss nicht, ob ich das im Bericht so verwenden kann, mmh, Aber es war ein Durcheinander!

{\tt 22:35: Aus dem hundeartigen, schwarzen Tier, das der nackte Nr.1 auf dem Rücken getragen hatte, kommt ein riesiger Vogel. Der Vogel gehört vermutlich zur Gattung der Reiher. Er schlug heftig mit den Flügeln und trifft dabei den Beamten Moser an der Nase, die daraufhin heftig zu bluten beginnt. Kollegin Meyer, die den nackten Nr. 2 festsetzten wollte, war ebenfalls ausser Gefecht gesetzt.}

Das musste, was Kollegin Meyer betraf, für den Moment reichen. Moser war nicht sicher, was genau passiert war\dots vermutlich würde er es nicht erfahren, weil er nicht den Mumm hatte, die junge Frau darauf anzuprechen. Er hatte gesehen, wie sie sich dem nackten Riesen mutig näherte. Doch statt ihn zu packen, hatte sie einen tiefen Atemzug unter seiner Achsel genommen und dann ihre Jacke und ihr Hemd aufgerissen. 

Mein Gott, was, wenn sie keinen BH getragen hätte\dots, dachte Moser und versuchte es sich nicht vorzustellen. "`Oh, mein Gott!"' hatte sie gerufen. Der nackte Nr. 2 wie Moser ihn nannte, hatte sie, nicht ohne Bedauern auf die Seite geschoben und: "`Spötr Meitschi!"' gesagt. Es war Moser ein Rätsel, denn in dem Durcheinander war er selbst in die Nähe der beiden Riesen geraten und es hatte ihm schier den Atem verschlagen. Die beiden rochen, wie ein Stall voller Pumas, die drei Monate Waschverbot bekommen hatten\dots Verstohlen hob Moser den Arm und schnupperte,\dots mmh, ein kleiner Puma lag schon drin\dots

{\tt 22:40: Die beiden nackten flüchteten hinter dem Reiher her das Gerbergässlein Richtung Leonhardskirche. Die Beamten stiegen unverzüglich in ihren Streifenwagen und fuhren zum Heuberg, Ecke Leonhardskirche. Die beiden Flüchtigen und der grosse Vogel befanden sich auf der Terasse auf dem Leonhardberg. 
...
\section*{2n.5}
\addcontentsline{toc}{section}{2n.5}
