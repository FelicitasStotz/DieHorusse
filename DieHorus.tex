...
Mein Gott, was, wenn sie keinen BH getragen hätte\dots, dachte Moser und versuchte es sich nicht vorzustellen. "`Oh, mein Gott!"' hatte sie gerufen. Der nackte Nr. 2 wie Moser ihn nannte, hatte sie, nicht ohne Bedauern auf die Seite geschoben und: "`So ischs Meitschi!"' gesagt. Es war Moser ein Rätsel, denn in dem Durcheinander war er selbst in die Nähe der beiden Riesen geraten und es hatte ihm schier den Atem verschlagen. Die beiden rochen, wie ein Stall voller Pumas, die drei Monate Waschverbot bekommen hatten\dots Verstohlen hob Moser den Arm und schnupperte,\dots mmh, ein kleiner Puma lag schon drin\dots
